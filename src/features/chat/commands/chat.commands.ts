...
export const ChatCommands = {
  ...
  async processMessage(data: {
    ...
    if (message.includes('produto') || message.includes('estoque') || message.includes('inventário')) {
      try {
    ...
    if (message.includes('movimentação') || message.includes('movimentações') || message.includes('movimento')) {
      try {
...
`;
  ...
  async generateSmartTitle(messages: Array<{ message: string; response: string }>) {
    ...
    if (allText.includes('produto') || allText.includes('estoque') || allText.includes('inventário')) {
    ...
    if (allText.includes('movimentação') || allText.includes('movimentações') || allText.includes('movimento')) {
    ...
    if (allText.includes('relatório') || allText.includes('relatorio') || allText.includes('relatórios')) {
    ...
    if (allText.includes('configuração') || allText.includes('configuracao') || allText.includes('config')) {
