...
export const AuthService = {
    ...
    getProfilePermissions: (params?: {
        ...
        fetch(`${URI}/profile/permissions`, { method: "GET", params }),
    ...
    update: (params: any) => fetch(URI, { method: "PUT", data: params }),
