...
export async function ReportRoutesWithMiddleware(fastify: FastifyInstance) {
  // Register middleware
  await fastify.register(require('../../middlewares/auth.middleware'))
  await fastify.register(require('../../middlewares/authorization.middleware'))
  await fastify.register(require('../../middlewares/granular-permissions.middleware'))
  ...
  fastify.get('/dashboard/stats', {
    ...
    preHandler: [
      ...
      fastify.authorize(['reports:read']),
      fastify.checkGranularPermission('reports', 'read')
    ],
  ...
  fastify.get('/financial', {
    ...
    preHandler: [
      fastify.authenticate,
      fastify.authorize(['reports:read', 'financial:read']),
      fastify.checkGranularPermission('reports', 'read')
    ],
  ...
  fastify.get('/user-activity', {
    ...
    preHandler: [
      fastify.authenticate,
      fastify.authorize(['reports:read', 'audit:read']),
      fastify.checkGranularPermission('reports', 'read')
    ],
  ...
  fastify.get('/export', {
    ...
    preHandler: [
      fastify.authenticate,
      fastify.authorize(['reports:export']),
      fastify.checkGranularPermission('reports', 'export')
    ],
  ...
  fastify.post('/schedule', {
    ...
    preHandler: [
      fastify.authenticate,
      fastify.authorize(['reports:schedule']),
      fastify.checkGranularPermission('reports', 'schedule')
    ],
