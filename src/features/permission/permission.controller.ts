...
} from '@/middlewares/granular-permissions.middleware';
...
export const PermissionController = {
  ...
  async createUserPermission(request: FastifyRequest<{
    Body: {
      userId: string;
      action: Action;
      resource?: string;
  ...
  async getUserPermissions(request: FastifyRequest<{
  ...
  async updateUserPermission(request: FastifyRequest<{
    Params: { id: string };
    Body: {
      action?: Action;
      resource?: string;
  ...
  async deleteUserPermission(request: FastifyRequest<{
    Params: { id: string }
  }>, reply: FastifyReply) {
    try {
      const { id } = request.params;
  ...
  async setStoreUserPermissions(request: FastifyRequest<{
    Body: {
      userId: string;
      storeId: string;
      storeRole: StoreRole;
  ...
  async getStoreUserPermissions(request: FastifyRequest<{
  ...
  async getUserEffectivePermissions(request: FastifyRequest<{
    Params: { userId: string };
  ...
  async testPermission(request: FastifyRequest<{
    Body: {
      userId: string;
      action: Action;
      resource?: string;
