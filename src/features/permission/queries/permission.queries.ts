...
export const getUserPermissions = async (prisma: any, filters: {
  userId: string;
  storeId?: string;
  action?: Action;
  active?: boolean;
...
export const getStoreUserPermissions = async (prisma: any, filters: {
  storeId: string;
  page?: number;
  limit?: number;
}) => {
...
export const getUserEffectivePermissions = async (prisma: any, context: {
  userId: string;
  storeId?: string;
}) => {
...
export const testPermission = async (prisma: any, context: {
  userId: string;
  action: Action;
  resource?: string;
  storeId?: string;
...
export const getExpiringPermissions = async (prisma: any, days: number = 7) => {
...
export const searchPermissions = async (prisma: any, query: string, limit: number = 10) => {
